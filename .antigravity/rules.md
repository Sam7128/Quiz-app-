...
- In this repository, use `pm-voice-transfer-text-ef4049a3` for project memory tasks.
...
- This repository root is `C:\Users\user\Desktop\voice transfer text`. Only use memory files, docs archives, and indexes inside this root.
<!-- <<< project-memory antigravity rules <<< -->
