...
- In this repository, use `pm-quiz-app-main-dfb4ded2` for project memory tasks.
...
- This repository root is `C:\Users\user\Desktop\Quiz-app--main`. Only use memory files, docs archives, and indexes inside this root.
<!-- <<< project-memory antigravity rules <<< -->
