...
- Do not claim implementation overlap (or “already exists”) without concrete citations. If search is available, use built-in search/grep tooling—not external CLI—to produce evidence.
