# Spec: Graph Node Interactions

## Purpose
Define handle connections, drag-to-create behavior, shape selection, and graph size protections.
...
## Verification
- 單元測試：驗證 `useGraphState` 的 `onConnectEnd` 邏輯
