...
export const NORMAL_MONSTERS: Monster[] = [
    {
        ...
        hurtImagePath: '/battle/monsters/slime_blue_hurt.png',
        attackImagePath: '/battle/monsters/slime_blue_attack.png',
        maxHp: 50,
        attackPower: 10,
        attackDialogues: [
            "啵啵啵～答錯了！",
    ...
    },
    {
        ...
        hurtImagePath: '/battle/monsters/goblin_green_hurt.png',
        attackImagePath: '/battle/monsters/goblin_green_attack.png',
        maxHp: 60,
        attackPower: 12,
        attackDialogues: [
            "嘿嘿嘿！笨蛋人類！",
    ...
    },
    {
        ...
        hurtImagePath: '/battle/monsters/bat_shadow_hurt.png',
        attackImagePath: '/battle/monsters/bat_shadow_attack.png',
        maxHp: 40,
        attackPower: 15,
        attackDialogues: [
            "嘶嘶嘶！",
...
export const ELITE_MONSTERS: Monster[] = [
    {
        ...
        hurtImagePath: '/battle/monsters/skeleton_warrior_hurt.png',
        attackImagePath: '/battle/monsters/skeleton_warrior_attack.png',
        maxHp: 100,
        attackPower: 18,
        attackDialogues: [
            "咯咯咯...無知者！",
    ...
    },
    {
        ...
        hurtImagePath: '/battle/monsters/orc_berserker_hurt.png',
        attackImagePath: '/battle/monsters/orc_berserker_attack.png',
        maxHp: 120,
        attackPower: 20,
        attackDialogues: [
            "嗚啊啊啊！",
...
export const BOSS_MONSTERS: Monster[] = [
    {
        ...
        hurtImagePath: '/battle/monsters/dragon_fire_hurt.png',
        attackImagePath: '/battle/monsters/dragon_fire_attack.png',
        maxHp: 200,
        attackPower: 25,
        attackDialogues: [
            "區區人類，敢挑戰龍族？",
    ...
    },
    {
        ...
        name: '巫妖王・涅克羅斯',
        difficulty: 'boss',
        imagePath: '/battle/monsters/lich_king.png',
        hurtImagePath: '/battle/monsters/lich_king_hurt.png',
        attackImagePath: '/battle/monsters/lich_king_attack.png',
        maxHp: 250,
        attackPower: 22,
        attackDialogues: [
            "無知的凡人...",
