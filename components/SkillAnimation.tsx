...
import { Flame, Snowflake, Zap, Circle, Sun, Sparkles, type LucideIcon } from 'lucide-react';
...
// 技能元素對應的圖標和顏色
const ELEMENT_CONFIG: Record<SkillElement, { Icon: LucideIcon; color: string; gradient: string }> = {
    fire: {
        Icon: Flame,
